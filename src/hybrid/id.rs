...
impl LazyStateID {
    ...
    pub(crate) const SENTINEL_UNKNOWN: LazyStateID =
        LazyStateID::new_unchecked(1 << LazyStateID::MAX_BIT);

    pub(crate) const SENTINEL_DEAD: LazyStateID = LazyStateID::new_unchecked(
        LazyStateID::SENTINEL_UNKNOWN.as_usize_unchecked() + 1,
    );

    pub(crate) const SENTINEL_QUIT: LazyStateID = LazyStateID::new_unchecked(
        LazyStateID::SENTINEL_DEAD.as_usize_unchecked() + 1,
    );

    const MASK_START: usize = 1 << (LazyStateID::MAX_BIT - 1);

    const MASK_MATCH: usize = 1 << (LazyStateID::MAX_BIT - 2);
    ...
    /// state.
    #[inline]
    pub(crate) const fn as_start(&self) -> LazyStateID {
    ...
    /// state.
    #[inline]
    pub(crate) const fn as_match(&self) -> LazyStateID {
        LazyStateID::new_unchecked(
    ...
    pub(crate) fn is_unknown(&self) -> bool {
        *self == LazyStateID::SENTINEL_UNKNOWN
    }
    ...
    pub(crate) fn is_dead(&self) -> bool {
        *self == LazyStateID::SENTINEL_DEAD
    }
    ...
    pub(crate) fn is_quit(&self) -> bool {
        *self == LazyStateID::SENTINEL_QUIT
    }
