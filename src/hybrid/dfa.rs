...
impl DFA {
    ...
    */
    ...
    pub fn find_leftmost_fwd(
        ...
        self.find_leftmost_fwd_at(cache, None, &Search::new(bytes))
    }
    ...
    pub fn find_leftmost_rev(
        ...
        self.find_leftmost_rev_at(cache, &Search::new(bytes))
    }
